...
export default {
  ...
  methods: {
    startCalendar(){
      ...
      startDate: this.revalida.dt_validade,
      showHeader: false,
      color: "primary"
    };
    ...
    loadData(){
      this.isLoading = true;
            revalidaService.getRevalida(this.revalida.id_revalida).then(
                (response) => {
                    let data = response.data;
                    this.revalida.id_lote = data.id_lote;
                    this.revalida.dt_validade = data.dt_validade;
                    this.startCalendar();
                },
                (error) => {
                    this.message =
  ...
  created() {
        this.revalida.id_revalida = this.$route.params.id;
        this.loadData();
    },
};
</script>
