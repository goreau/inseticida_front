    ...
    loadData() {
      ...
      pedidoService.getPedido(this.pedido.id_pedido).then(
        (response) => {
          ...
          this.pedido.est_casos = data.est_casos;
          this.pedido.est_consumo = data.est_consumo;
          this.pedido.est_imoveis = data.est_imoveis;
          this.pedido.est_montada = data.est_montada;
