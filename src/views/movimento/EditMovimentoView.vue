                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <CmbLocalMov :id_prop="currentUser.id" :tipo="movimento.tipo"
                                        @selUnid="movimento.or_dest = $event" :sel="movimento.or_dest"
...
export default {
    ...
    methods: {
        ...
        loadData(){
            this.isLoading = true;
            movimentoService.getMovimento(this.movimento.id_movimento).then(
                (response) => {
                    let data = response.data;
                    this.movimento.tipo = data.tipo;
                    this.movimento.or_dest = data.or_dest;
                    this.movimento.dt_movimento = data.dt_movimento;
                    this.movimento.id_lote = data.id_lote;
                    this.movimento.quantidade = data.quantidade;
                    this.movimento.master = data.master;
                    this.startCalendar();
                },
                (error) => {
                    this.message =
